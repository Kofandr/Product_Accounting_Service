...
Учебный REST API сервис для учёта товаров и категорий. Писал его чтобы отработать чистую архитектуру, unit-тесты с моками и работу с PostgreSQL. Основной фокус — качество кода и покрытие тестами.  
